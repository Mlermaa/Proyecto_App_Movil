...
public class TinyDB {
    ...
    public ArrayList<ProductosDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductosDomain> playerList =  new ArrayList<ProductosDomain>();

        for(String jObjString : objStrings){
            ProductosDomain player  = gson.fromJson(jObjString,  ProductosDomain.class);
    ...
    public void putListObject(String key, ArrayList<ProductosDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProductosDomain player: playerList){
